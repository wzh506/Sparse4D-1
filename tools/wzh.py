...
if __name__ == "__main__":
    ...
    if hasattr(cfg, "plugin"):
        if cfg.plugin:
            ...
            if hasattr(cfg, "plugin_dir"):
                ...
                plg_lib = importlib.import_module(_module_path)#这一步已经完成了所有modules的注册
            else:
    ...
    model = build_model(cfg.model, train_cfg=cfg.get("train_cfg"), test_cfg=cfg.get("test_cfg"))  #如何build
    #这里还没有问题对吧
